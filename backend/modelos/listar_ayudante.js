		...
		if (arrays.length==1){
			...
			jwt.verify(arrays[0], 'clWve-G*-9)1', function(err, decoded) {
				if (err) {
					...
					/*
					extraigo lista de ayudantes de la empresa
					*/
					
					redisClient.keys('listado_'+decoded.d+'_ayudante_*',function(err3,reply3){
						if(reply3.length > 0){
							
							/*
							guardo resultado en los datos con recursividad
							*/
