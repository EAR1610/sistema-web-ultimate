		...
		if (arrays.length==2){
			...
			jwt.verify(arrays[0], 'clWve-G*-9)1', function(err, decoded) {
				if (err) {
					...
					/*
					extraigo lista de pendiente del asesor
					*/
					
					redisClient.keys("pendiente_"+arrays[1]+"_*",function(err3,reply3){
						if(reply3.length > 0){
							
							/*
							recursividad y traigo los datos de los pendientes
							*/
