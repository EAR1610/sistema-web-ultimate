eje = function(arrays,origen,redisClient) {
	return new Promise(function(resolve, reject) {
		...
		/*
			Recibo un array con los valores token,idasesor,idempresa y dia de la semana;
		*/
		if (arrays.length == 4){		
			...
			jwt.verify(arrays[0], 'clWve-G*-9)1', function(err, decoded) {
				if (err) {
					...
					/*
						busco registro de contratos de cada asesor
					*/		
									...
									if( ind == arrs.length ){									
										...
										redisClient.get(arrs[ind],function(exrrs,daxtse) {
											if( daxtse !== null && daxtse !== undefined ) {
                                                ...
                                                /* 
                                                    ALGORITMO PARA MOSTRAR LOS CONTRATOS SEGUN EL DIA DE LA SEMANA
                                                */
                                               if( arrays[3] == 'L'){
                                                    for(let contrato of infeos[13]) {
                                                        var fechaPago = new Date(contrato.fe + "T00:00:00");
                                                        fechaPago.setHours(fechaPago.getHours() + 6); // Ajusta la hora a GMT-6
                                                        if(fechaPago.getDay() == 1 && contrato.ct == false) {
                                                            codigoCliente = inus[1];
                                                            break;
                                                        }
                                                    }
                                               } else if( arrays[3] == 'M'){
                                                    for(let contrato of infeos[13]) {
                                                        var fechaPago = new Date(contrato.fe + "T00:00:00");
                                                        fechaPago.setHours(fechaPago.getHours() + 6); // Ajusta la hora a GMT-6
                                                        if(fechaPago.getDay() == 2 && contrato.ct == false) {
                                                            codigoCliente = inus[1];
                                                            break;
                                                        }
                                                    }
                                                    ...
                                                    for(let contrato of infeos[13]) {
                                                        var fechaPago = new Date(contrato.fe + "T00:00:00");
                                                        fechaPago.setHours(fechaPago.getHours() + 6); // Ajusta la hora a GMT-6
                                                        if(fechaPago.getDay() == 3 && contrato.ct == false) {
                                                            codigoCliente = inus[1];
                                                            break;
                                                        }
                                                    }
                                                    ...
                                                    for(let contrato of infeos[13]) {
                                                        var fechaPago = new Date(contrato.fe + "T00:00:00");
                                                        fechaPago.setHours(fechaPago.getHours() + 6); // Ajusta la hora a GMT-6
                                                        if(fechaPago.getDay() == 4 && contrato.ct == false) {
                                                            codigoCliente = inus[1];
                                                            break;
                                                        }
                                                    }
                                                    ...
                                                    for(let contrato of infeos[13]) {
                                                        var fechaPago = new Date(contrato.fe + "T00:00:00");
                                                        fechaPago.setHours(fechaPago.getHours() + 6); // Ajusta la hora a GMT-6
                                                        if(fechaPago.getDay() == 5 && contrato.ct == false) {
                                                            codigoCliente = inus[1];
                                                            break;
                                                        }
                                                    }
                                                    ...
                                                    for(let contrato of infeos[13]) {
                                                        var fechaPago = new Date(contrato.fe + "T00:00:00");
                                                        fechaPago.setHours(fechaPago.getHours() + 6); // Ajusta la hora a GMT-6                                                        
                                                        if(fechaPago.getDay() == 6 && contrato.ct == false) {
                                                            codigoCliente = inus[1];
                                                            break;
                                                        }
                                                    }
												...
												*/
												redisClient.get("cliente_"+codigoCliente,function(errs,datse){													
